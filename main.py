...
app = FastAPI(
    title="🏥 MediBlaze API",
    description="Advanced Medical AI Assistant with RAG and Web Search capabilities",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc"
)
...
async def health_check():
    ...
    try:
        ...
        env_status = "✅ Configured" if os.getenv("PINECONE_API_KEY") and os.getenv("GOOGLE_API_KEY") else "❌ Missing Keys"
